package com.healthcenter.special;

import com.github.qcloudsms.httpclient.HTTPException;
import com.healthcenter.pojo.*;
import com.healthcenter.service.*;
import com.healthcenter.pojo.Equipment;
...
import com.healthcenter.util.CloudMsgUtil;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Component;

import javax.annotation.PostConstruct;

import static com.healthcenter.special.MsgQueue.*;
...
//            influxDBConnector.insertData("temperature", tags, fields);
    ...
    private void sendPhoneMessage(String objectId,String eqpId,String message,String alarmType,float alarmValue,String detail) {
        ...
        com.healthcenter.pojo.Object object = socketTask.objectService.queryObjectByObjectId(objectId);
